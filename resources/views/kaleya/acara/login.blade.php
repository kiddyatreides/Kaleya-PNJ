...
<head>
  ...
  <link rel="stylesheet" href="{{asset('acara/bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('acara/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Kalender</b>Budaya</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in untuk daftarkan acara</p>
...
<!-- iCheck -->
<script src="{{asset('acara/plugins/iCheck/icheck.min.js')}}"></script>
<script>
    $(function () {
        $('input').iCheck({
